...
# CSS
Watch this ~17 minute instructional video on selection in CSS:
[CSS - Selection](https://www.youtube.com/watch?v=g0Aq2kP5-CY&index=5&list=PLdnONIhPScST0Vy4LrIZiYKpFNoxgyH7J)

_Note:_ Youtube lets you watch things at higher speed (such as 1.5x speed). Click on the gear and select speed.
...
## Setup
In the `homework` folder for tonight, create a file called `solutions.js`. Write your answers in this file.
<br>
